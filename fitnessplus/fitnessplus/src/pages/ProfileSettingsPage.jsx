    ...
    <div className={`min-h-screen w-screen ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-100 text-gray-900'} flex flex-col items-center`}>
      <div className={`w-11/12 md:w-1/2 ${darkMode ? 'bg-gray-800 text-white' : 'bg-white text-black'} shadow-md rounded-lg p-8 mt-20`}>
        ...
        <div className="space-y-6">
          <button className="w-full bg-blue-700 text-white py-2 rounded-full hover:bg-blue-800" onClick={() => setShowManage(true)}>
            Manage Account
          </button>
          <button className="w-full bg-blue-700 text-white py-2 rounded-full hover:bg-blue-800" onClick={() => setShowThemeSelection(true)}>
            Theme Selection
          </button>
          <button className="w-full bg-blue-700 text-white py-2 rounded-full hover:bg-blue-800" onClick={() => setShowNotifications(true)}>
            Notification Preferences
          </button>
          <button className="w-full bg-blue-700 text-white py-2 rounded-full hover:bg-blue-800" onClick={() => setShowPrivacy(true)}>
            Privacy Settings
          </button>
        </div>
      </div>
