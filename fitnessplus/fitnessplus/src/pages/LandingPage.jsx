      ...
      <div className="bg-white rounded-lg shadow-lg w-11/12 xl:w-4/5 flex flex-col items-center">
        ...
        <div className="flex flex-col justify-center items-center p-10 w-full">
          ...
          <button
            ...
            className="bg-blue-700 text-white py-2 px-8 rounded-full w-3/4 md:w-2/4 hover:bg-blue-800 mb-4"
          >
            Join
          </button>
          <div className="border-t w-full mt-4 pt-4 text-center">
            ...
            <button
              ...
              className="bg-blue-700 text-white py-2 px-8 rounded-full w-3/4 md:w-2/4 hover:bg-blue-800"
            >
              Sign in
            </button>
          </div>
